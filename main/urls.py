...
urlpatterns = [
    ...
    path("change-credentials/<int:id>",
         views.changeCredentials, name="change_credentials"),
    path("pandit-login", views.panditLogin, name="panditLogin"),
    ...
    # path("book/<str:nameOfPuja>", views.sortBook, name="sortBook"),
